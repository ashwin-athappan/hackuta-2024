        ...
        <section className="py-10 bg-white">
          <div className="container mx-auto px-6">
            ...
            <p className="text-gray-600 mb-4">
              Subletting can lead to various problems for landlords, tenants, and communities, including:
            </p>
            ...
            <ul className="list-disc list-inside text-gray-600 mb-4">
              ...
              <li>In 2022, the estimated losses due to unauthorized subletting exceeded $15 billion in the U.S.</li>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                {tasks.passport && (
                  <p className="text-green-600 mt-2">
                    {tasks.passport.name} uploaded successfully!
                  </p>
                )}
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                {tasks.leaseAgreement && (
                  <p className="text-green-600 mt-2">
                    {tasks.leaseAgreement.name} uploaded successfully!
                  </p>
                )}
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                {tasks.i94 && (
                  <p className="text-green-600 mt-2">
                    {tasks.i94.name} uploaded successfully!
                  </p>
                )}
              </div>
