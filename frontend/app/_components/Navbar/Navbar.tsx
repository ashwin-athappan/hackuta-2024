    ...
    return (
        <nav className="bg-gray-300">
            <div className="px-4">
                <div className="flex justify-between">
                    ...
                    <div className="hidden md:flex items-center space-x-1">
                        ...
                        <a href=""
                           className="py-2 px-3 bg-black hover:bg-white text-white hover:text-black rounded transition duration-300">Signup</a>
                    </div>
            ...
            <div className="mobile-menu hidden md:hidden">
                ...
                <a href="#" className="text-black block py-2 px-4 text-sm hover:bg-gray-200">Login</a>
                <a href="#" className="text-black block py-2 px-4 text-sm hover:bg-gray-200">Signup</a>
            </div>
        </nav>
    );
}